# .\_iso3166a2.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:4bc75b8feb949feaad34ef2ebcb41d29d3cb1349
# Generated 2015-08-12 15:54:17.334000 by PyXB version 1.2.4 using Python 2.7.0.final.0
# Namespace http://ddex.net/xml/20100121/iso3166a2 [xmlns:iso3166a2]
...
Namespace = pyxb.namespace.NamespaceForURI('http://ddex.net/xml/20100121/iso3166a2', create_if_missing=True)
...
# Atomic simple type: {http://ddex.net/xml/20100121/iso3166a2}TerritoryCode
class TerritoryCode (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://ddex.net/xml/20100121/iso3166a2.xsd', 3, 4)
