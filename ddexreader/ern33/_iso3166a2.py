# ./_iso3166a2.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:fd9142caf507dfa8cda2692feba52b5a829d3609
# Generated 2015-07-06 15:43:13.576552 by PyXB version 1.2.4 using Python 2.7.6.final.0
# Namespace http://ddex.net/xml/20110630/iso3166a2 [xmlns:iso3166a2]
...
Namespace = pyxb.namespace.NamespaceForURI('http://ddex.net/xml/20110630/iso3166a2', create_if_missing=True)
...
# Atomic simple type: {http://ddex.net/xml/20110630/iso3166a2}TerritoryCode
class TerritoryCode (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):

    """An ISO 3166-1 two-letter code representing a
                Territory."""

    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'TerritoryCode')
    _XSDLocation = pyxb.utils.utility.Location('http://ddex.net/xml/20110630/iso3166a2.xsd', 4, 4)
    _Documentation = 'An ISO 3166-1 two-letter code representing a\n                Territory.'
