# ./_iso4217a.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aef8b946bf879e51a8e883f8b8d187bc595a0f69
# Generated 2015-07-06 15:44:16.553772 by PyXB version 1.2.4 using Python 2.7.6.final.0
# Namespace http://ddex.net/xml/20120214/iso4217a [xmlns:iso4217a]
...
Namespace = pyxb.namespace.NamespaceForURI('http://ddex.net/xml/20120214/iso4217a', create_if_missing=True)
...
# Atomic simple type: {http://ddex.net/xml/20120214/iso4217a}CurrencyCode
class CurrencyCode (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://ddex.net/xml/20120214/iso4217a.xsd', 10, 3)
