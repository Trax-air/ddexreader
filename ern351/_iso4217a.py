# ./_iso4217a.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:39c3e224cd30cd39016d8e51bcd02564437ab444
# Generated 2015-07-06 15:56:21.649906 by PyXB version 1.2.4 using Python 2.7.6.final.0
# Namespace http://ddex.net/xml/20121219/iso4217a [xmlns:iso4217a]
...
Namespace = pyxb.namespace.NamespaceForURI('http://ddex.net/xml/20121219/iso4217a', create_if_missing=True)
...
# Atomic simple type: {http://ddex.net/xml/20121219/iso4217a}CurrencyCode
class CurrencyCode (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://ddex.net/xml/20121219/iso4217a.xsd', 9, 3)
